  ...
  return (
    <div className={`${className} flex  text-sm`}>
      <div className={`flex space-x-2`}>
        ...
        >
          <span className={`text-gray-500 mr-1`}>{meta.total_results}</span>
          <span className={`text-gray-500 mr-1`}>Total Results</span>
        </div>
        <div
          className={`-rotate-180 rounded-lg text-lg px-2 py-2 bg-ter-750 cursor-pointer text-txt-1000 hover:bg-ter-500 `}
          onClick={() => {
        ...
        <div
          className={`rounded-lg px-2 py-2 bg-ter-750 cursor-pointer text-txt-1000 hover:bg-ter-500 text-sm`}
          onClick={() => {
