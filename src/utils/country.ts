...
const reverseCountryMap = Object.fromEntries(
  Object.entries(countryMap).map(([isoCode, countryName]) => [
    countryName,
    isoCode,
  ])
);
...
const getIsoCodeFromCountryName = (countryName: string): string => {
  return reverseCountryMap[countryName] || "";
};

export { getCountryName, getIsoCodeFromCountryName };
